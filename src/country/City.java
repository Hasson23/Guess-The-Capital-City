...
public class City extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose Here", "Djabouti", "kenya", "Mali", "Somalia", "Uganda", "Yemen","Moroco" }));
        ...
        jLabel1.setText("Nairobi is the capital city of:");

        jTextField1.setEditable(false);
        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel2.setText("Currect Answer");
    ...
    String SelectAns = (String) jComboBox1.getSelectedItem();
    if(Ans==SelectAns){
        jTextField1.setText("Currect Answer");
        jTextField2.setText(Ans);
    }
    else {
         jTextField1.setText("InCurrect Answer");
         jTextField2.setText(Ans);
    }
